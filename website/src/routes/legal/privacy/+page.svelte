...
<svelte:head>
	<title>Privacy Policy | Darkian Mail</title>
	<meta
		name="description"
		content="Learn how Darkian Mail protects your privacy and handles your email data."
	/>
	<meta name="keywords" content="privacy, policy, data protection, email, darkianmail" />
	<meta property="og:title" content="Privacy Policy | Darkian Mail" />
	<meta
	...
	<Card.Root class="mb-20 p-6">
		...
		<div class="space-y-6">
			<Card.Content>
				...
				<p class="mb-4">
					At Darkian Mail, we prioritize the privacy and security of your email communications. Our
				...
				<div class="space-y-4">
					<div>
						...
						<ul class="ml-6 list-disc space-y-1">
							<li>Username and Domain (forming your unique email address)</li>
			...
			<Card.Content>
				...
				<ul class="ml-6 list-disc space-y-2">
					<li><strong>Providing Email Services:</strong> Delivering emails over standard SMTP, storing emails and attachments, managing contacts and drafts.</li>
					<li><strong>Security and Authentication:</strong> Verifying your identity and protecting against unauthorized access.</li>
					...
					<li><strong>Feature Provision:</strong> Enabling features like scheduled sending, email expiration, self-destruct, snoozing, and notifications.</li>
			...
			<Card.Content>
				...
				<ul class="ml-6 list-disc space-y-2">
					<li><strong>Mail Servers:</strong> When you send an email, we transmit the necessary email data (sender, recipient, subject, body, attachments) to the recipient's mail server via standard SMTP.</li>
			...
			<Card.Content>
				...
				<ul class="ml-6 list-disc space-y-2">
					...
					<li><strong>Encryption:</strong> We encourage secure connections for web access (HTTPS). Data at rest in the database and object storage is protected by provider security measures.</li>
					<li><strong>Spam Mitigation:</strong> Local keyword-based filtering to reduce spam.</li>
			...
			<Card.Content>
				...
				<p class="mb-4">
					...
					continued use of Darkian Mail after changes constitutes acceptance of the updated policy.
				</p>
			</Card.Content>
