<script lang="ts">
	...
	const features = [
		{
			...
			icon: 'Hash',
			title: '@ Addressing',
			description: 'Simple addresses like user@domain'
		},
		{
			id: 'self-hosting',
			icon: 'Server',
		...
		},
		{
			...
			description: 'Self-hosted filtering with automatic inbox classification'
		},
		{
			id: 'scheduling',
			icon: 'Clock',
		...
		},
		{
			...
			description: 'Instant messaging between Darkian Mail users, for the funnies'
		},
		{
			id: 'classification',
			icon: 'Sparkles',
	...
	const testimonials = [
		{
			...
			quote:
				"I use Darkian Mail, it no googlie~ ✨ It vewy good!! I wike it sooo much~ 💖 A design which doesn't make me feew wike an ancient stony-wony 🗿💦 Awso, suuuuper easy to use~! 10/10 woud wecommend using dis, makes u feew vewy coow and pwoerfuw~!! 💪😤💫"
		},
		{
			id: 'linker',
			...
			role: 'Ragebaiter',
			quote:
				"Darkian Mail transformed the way I launder money, with the anti spam features I was able to ignore any messages from the IRS and the CIA regarding my activities. It's simply an amazing platform for a young entrepreneur like me"
		},
		{
			id: 'papaya',
			...
			quote:
				'Me use Darkian Mail for send many email. Before email make cry now, me smile. Its fast like zoom zoom Button go click, email go.  No crash yet (only once, but i  press the wrong thing). Best email I use since yesterday ✅ 10/10 maybe even 11. Darkian Mail is mail so good :D'
		}
	];
	...
	const founder = {
		name: 'lordpipon',
		title: 'Founder & CEO',
		avatar: '/testimonials/lordpipon.png',
		quote:
			'I created Darkian Mail because I believe email should be under your control, not in the hands of big corporations that mine your data. Our mission is to man this shit is boring! Can I get back to watching Clash Royale gameplay? Probably not until I finish writing this shit. Anyway, where was I? dakrian mial yesyes is faeveyr interesting aang aeyou know you shouDLa nake an account right nwo FUCK i cannot fuckin TYPE WITHTHIS KEYBOARD'
	};

	const trustedCompanies = [
		{ name: 'Darkian', logo: '/companies/darkian.png', title: 'The brand' },
		{ name: 'Catplay', logo: '/companies/catplay.png', title: 'Playful engineers' },
		{ name: 'Cloudflare', logo: '/companies/cloudflare.svg', title: 'Edge infrastructure' },
		{ name: '67 sigma tiki tiki', logo: '/companies/sigma.svg', title: 'Certified sigma' }
	];
...
>
	<h1 class="text-6xl font-bold">
		...
		<span class="relative mx-2 inline-block">
			...
			></span>
			<span class="text-primary relative px-2">just for you</span>
		</span>
	</h1>
	...
	<div class="container mx-auto px-4 py-16">
		...
		<div class="mx-auto max-w-3xl">
			...
			<div class="mt-12 text-center">
				<Button href="/signup" size="lg" variant="default">Join Darkian Mail Today</Button>
			</div>
		</div>
	</div>
</div>
